<?php
   ...
   $tieneCoche = true;
   $edad = null;
   $puedeConducir = $edad > 18 && $tieneCoche;
   $puedeConducir = $edad > 18 || $tieneCoche;
   $tieneCoche = !$tieneCoche; // Almacena el valor contrario del boolean

   const PI = 3.14; //Constante por archivo
